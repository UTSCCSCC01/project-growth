''' Django notificatonForum urls file '''
# -*- coding: utf-8 -*-
...
urlpatterns = [
    pattern(r'^$', views.AllnotificationsForumList.as_view(), name='all'),
    pattern(r'^unread/$', views.UnreadnotificationsForumList.as_view(), name='unread'),
