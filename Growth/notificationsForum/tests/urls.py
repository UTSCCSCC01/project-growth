''' Django notificatonForum urls for tests '''
# -*- coding: utf-8 -*-
from distutils.version import StrictVersion  # pylint: disable=no-name-in-module,import-error

from django import get_version
from django.contrib import admin
from notificationsForum.tests.views import (live_tester,  # pylint: disable=no-name-in-module,import-error
                                       make_notification)
...
if StrictVersion(get_version()) >= StrictVersion('2.1'):
    ...
    urlpatterns = [
        ...
        path('', include('notificationsForum.urls', namespace='notificationsForum')),
    ]
    ...
    urlpatterns = [
        ...
        url(r'^', include('notificationsForum.urls', namespace='notificationsForum')),
