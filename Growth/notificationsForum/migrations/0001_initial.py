    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient', models.ForeignKey(related_name='notificationsForum', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ...
            options={
                'swappable': swapper.swappable_setting('notificationsForum', 'NotificationForum'),
                'ordering': ('-timestamp',),
            },
            bases=(models.Model,),
        ),
