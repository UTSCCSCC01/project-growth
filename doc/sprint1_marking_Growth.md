...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - CRC Cards [or equivalent, if the team is not using CRC) (max 4 marks)
    ...
    Your Mark: 2: "messaging other users" does not sound like a single class, navigation-bar reference non-listed pages
  ...
  - Software Architecture Diagram (max 4 marks)
    ...
    Your Mark: 3: Interaction between MVC components are not explained
...
## Documentation (max 3 marks)
  ...
  - 3 marks = documentation has been created for frontend and backend systems with great detail
  - 2 marks = documentation has been created for frontend and backend systems with some errors
