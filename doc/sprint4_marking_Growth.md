...
## Planning Meetings (SR(N-1).md, sprintN.md) (max 2 marks)
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 1 spikes not clearly identified
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    GROW-103 is nnot broken into substasks
...
Tracker: 2 marks if the feature(s) the team is demonstrating are marked as "Finished" on pivotal tracker, 
1 mark if they marked partially finished, 0 marks if tracker is not updated.
