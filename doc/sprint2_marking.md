...
Comment: one day per standup only. You cannot have standup multiple times on a day.
...
## Tracking on Jira  (max 24 marks) 
  ...
  Comment: cydy8001 has non-meaningful commit message.
