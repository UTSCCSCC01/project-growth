...
## Process: process.md (max 10 marks)
  - Team organization (roles) divided clearly (max 2 marks)
    ...
    Your mark: 1
    Feedback: Team organization is provided but we're looking more for your team organization/roles for the project itself, not for sprint 0 (ie. UX, frontend, backend, scrum master etc.)
